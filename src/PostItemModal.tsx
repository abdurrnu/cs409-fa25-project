...
export const PostItemModal: React.FC<PostItemModalProps> = ({ isOpen, onClose, onItemAdded, user }) => {
            ...
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" value={user} disabled className="disabled-input" />
                        <small>Users will contact you via {user}@illinois.edu</small>
                    </div>
